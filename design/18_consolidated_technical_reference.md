...
| glass_narrows | HoldOut | 75초 버티기 |
| sunken_arcade | CollectPickups | 5개 픽업 |
| lighthouse_crown | HoldOut | 90초 버티기 |
...
|------|------------|----------------|-------------|------------|---------|-------------|------------------|---------------------|---------------|-------------------|
| Sunken Dock | 10 | **5** | 3 | **3** | 180초 | **210초** | 30 + 수집 | **25 + 수집** | 8 + 수집 | **6 + 수집** |
| Reed Fields | 18 | **10** | 5 | **SeedPod 5개** | 220초 | **195초** | 45 + 수집 | **30 + 수집** | 16 + 수집 | **8 + 수집** |
| Tidal Vault | 28 | **15** | 7 | **CleanWater 3개** | 260초 | **180초** | 70 + 수집 | **35 + 수집** | 24 + 수집 | **10 + 수집** |
| Glass Narrows | 36 | **20** | 8 | **HoldOut 75초** | 300초 | **180초** | 90 + 수집 | **40 + 수집** | 30 + 수집 | **12 + 수집** |
| Sunken Arcade | 44 | **25** | 9 | **5개 픽업** | 320초 | **165초** | 110 + 수집 | **50 + 수집** | 36 + 수집 | **15 + 수집** |
| Lighthouse Crown | 54 | **30** | 10 | **HoldOut 90초** | 360초 | **150초** | 140 + 수집 | **60 + 수집** | 44 + 수집 | **20 + 수집** |
